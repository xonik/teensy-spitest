...
extern uint32_t         txBuffer[9];
extern EventResponder  callbackHandlerFast;
...
//  }
  ...
  void transfer24(const void * buf, size_t count);

  // Asynch support (DMA )
#ifdef SPI_HAS_TRANSFER_ASYNC

  bool transfer(const void *txBuffer, size_t count);
  bool transferSetup();
  const void *myBuf = nullptr;
